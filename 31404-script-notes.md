 ...
 * `OP_SHA256` (& `OP_HASH256`) returns a 256-bit (32 bytes) hash, that's why a
 ...
 P2WPKH | OP_2 OP_PUSHBYTES_72 72_BYTES_SIG OP_PUSHBYTES_33 33_BYTES_PUBKEY | 0248<144-chars>21<66-chars
 P2WSH | OP_3 OP_0 OP_PUSHBYTES_72 72_BYTES_SIG OP_PUSHBYTES_XX XX_BYTES_SCRIPT | 030048<144-chars><XX-in-hex><XX*2-chars>
 P2TR - KeyPath | OP_1 OP_PUSHBYTES_65 65_BYTES_SIG | 5141<130-chars>
 P2TR - ScriptPath | OP_3
